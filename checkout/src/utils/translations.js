export const translations = {
  ...
  ar: {
    ...
    productNotFoundDesc: "المنتج الذي تبحث عنه غير موجود أو لم يعد متاحاً.",
  ...
  ku: {
    ...
    yourCartEmpty: "سەبەتەکەت بەتاڵە",
    productsTotal: "کۆی بەرهەمەکان:",
    deliveryFee: "کرێی گەیاندن:",
    total: "کۆی گشتی:",
    completeCheckout: "تەواوکردنی کڕین",
    processing: "لە بەرنامەدایە...",
    ...
    productNotFoundDesc: "ئەو بەرهەمەی بەدوایدا دەگەڕێیت بوونی نییە یان چیتر بەردەست نییە.",
